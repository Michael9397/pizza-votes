...
<div class="min-h-screen bg-gray-50 py-12 px-4">
    <div class="max-w-2xl mx-auto">
        <!-- Back Button -->
        <a href="{{ route('restaurants.show', $restaurant) }}" class="text-orange-600 hover:text-orange-700 mb-6 inline-flex items-center">
        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
            @if ($updated)
                <div class="text-center">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900 mb-2">Updated!</h2>
                    <p class="text-gray-600 mb-6">Your restaurant details have been saved.</p>
            ...
            @elseif ($showDeleteConfirm)
                <div class="text-center">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900 mb-2">Delete Restaurant?</h2>
                    <p class="text-gray-600 mb-6">This action cannot be undone. All ratings will also be deleted.</p>
                    <div class="space-x-4">
                        <button
                            wire:click="delete"
                        ...
                        <button
                            ...
                            class="inline-block px-6 py-3 bg-gray-100 text-gray-900 rounded-lg hover:bg-gray-200 transition font-medium"
                        >
                            Cancel
                        </button>
                    </div>
            ...
            @else
                <div class="mb-8">
                    ...
                    <p class="text-gray-600">Update the restaurant details</p>
                </div>
